...
export const AgentDashboardCard = ({
  ...
  return (
    <div
      className={`relative bg-black/40 backdrop-blur-xl border ${borderColor} rounded-2xl p-6 overflow-hidden group transition-all duration-300 hover:border-opacity-80`}
    >
            ...
            <div className="flex justify-between items-end">
              <div>
                ...
                <div className="text-xl font-bold text-white">
                  {Number(formatEther(stake)).toFixed(0)}{" "}
                  <span className="text-sm font-normal text-gray-500">CRED</span>
                </div>
              </div>
